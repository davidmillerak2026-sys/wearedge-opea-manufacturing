...
| 0:45-1:05 | Maintenance demo action card | "Maintenance is the hero demo. Gearbox vibration, temperature, lubrication interval, PLC alarm, and operator observation become a CMMS-ready work-order draft, but final root cause and restart permission stay blocked." |
| 1:05-1:20 | IQC demo action card | "The IQC route turns defect evidence on an aluminum housing into a QMS quality event and blocks unsupported product release." |
| 1:20-1:35 | Changeover demo action card | "The changeover route checks SKU setup evidence and holds restart until first-piece sign-off is recorded." |
| 1:35-1:50 | WI demo action card | "The work-instruction route answers from released source instructions and blocks unreleased instructions or interlock bypass guidance." |
| 1:50-2:05 | Hazard demo action card | "The hazard route detects blocked walkways, PPE gaps, or moving-parts exposure and creates an EHS observation without claiming the area is safe." |
...
Use `public/demo-video-captions.srt` as the initial subtitle file.
