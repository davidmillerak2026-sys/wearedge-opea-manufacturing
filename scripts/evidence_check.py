...
REQUIRED_LOCAL_FILES = [
    ...
    "docs/optimization-plan-status-2026-06-05.md",
    ...
    "docs/opea-reranker-profile.md",
    "docs/kubernetes-optional-profile.md",
    ...
    "docs/opea-upstream/final-evidence-update-comment.md",
    ...
    "evals/genaieval/official_wearedge_benchmark.yaml",
    ...
    "evidence/genaieval/official_benchmark_summary.json",
