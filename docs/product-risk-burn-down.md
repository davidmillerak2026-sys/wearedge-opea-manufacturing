...
| Upstream OPEA PR has current checks passing but is not merged | Public RFC and comments are posted; direct push was blocked by GitHub 403; fork push succeeded; upstream PR #2462 is open; pre-commit.ci, DCO, dependency-review, get-test-matrix, get-test-case, and compose-test pass on the current PR head; contribution patch is smoke-tested; minimal first-PR scope is documented for maintainers; docs PR #395 is open but not merged | `docs/opea-upstream/rfc-issue-working-copy.md`, `docs/opea-upstream/implementation-feedback-comment.md`, `docs/opea-upstream/tei-update-comment.md`, `docs/upstream-pr-attempt-2026-05-28.md`, `docs/opea-upstream/pr-ready/`, `https://github.com/opea-project/GenAIExamples/pull/2462`, `https://github.com/opea-project/docs/pull/395` | This is stronger than prepared-package evidence but still weaker than reviewed or merged upstream contributions; do not claim the PR is accepted, reviewed, or merged until maintainers complete it |
