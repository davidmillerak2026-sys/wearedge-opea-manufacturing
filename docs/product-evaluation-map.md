...
| Open-source evidence | Public contribution evidence | Evidence gap to watch | Public RFC, comments, CI-green GenAIExamples PR #2462, and open/mergeable OPEA docs Publications PR #395 exist; product evidence is stronger if maintainers engage, merge, or request changes that we address. |
