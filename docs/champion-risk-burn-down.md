...
| Knowledge-sharing bonus may be discounted if GitHub-only | Burned down: external Dev.to article and YouTube demo video are published | Dev.to article, YouTube video, `docs/publication-record.md` | Do not claim additional platforms beyond the recorded Dev.to and YouTube URLs |
