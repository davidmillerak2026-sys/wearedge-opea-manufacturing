...
| Knowledge-sharing bonus may be discounted if GitHub-only | GitHub article/video evidence is public and external-platform article/video metadata are copy-ready | `public/article-wear-edge-opea-manufacturing.md`, `public/external-platform-article.md`, `public/video-platform-description.md`, `docs/publication-record.md` | Do not claim Medium/LinkedIn/Dev.to/YouTube/Bilibili publication until a real external URL is posted |
